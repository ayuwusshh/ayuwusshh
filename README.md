...
💡 Computer Science undergraduate with a strong interest in building scalable systems and solving problems through code.

🚀 I love building **real-world, scalable full-stack applications**, with a solid foundation in **DSA, MERN stack, and cloud deployment**.  
Hands-on experience through projects, hackathons, and continuous learning.  
I enjoy breaking complex problems into clean, practical solutions and sharing what I learn with the developer community on LinkedIn.
...
- Real-time collaboration & video communication
- Designed for distributed teams
- Built with scalability and production readiness in mind

📂 GitHub Repo: [CollabSuite](https://github.com/ayuwusshh/Collabsuite)
🚧 Live Demo: Coming soon

### 🔹 QuickAI (Full-Stack MERN Project)
A production-ready AI-powered web application built using the MERN stack.
...
📂 GitHub Repo: [QuickAI](https://github.com/ayuwusshh/QuickAi)
...
- Practicing DSA regularly on LeetCode with focus on logic building & optimization
